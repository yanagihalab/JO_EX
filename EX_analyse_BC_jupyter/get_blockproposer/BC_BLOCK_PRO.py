...
# CosmosのRPCエンドポイント
RPC_URL = "https://babylon-rpc.publicnode.com:443"
BLOCK_COUNT = 5000  # 遡るブロック数
...
# CSVとして保存
df.to_csv("Blockchian_block_data.csv", index=False)
print("データを 'Blockchian_block_data.csv' に一時保存しました。")
